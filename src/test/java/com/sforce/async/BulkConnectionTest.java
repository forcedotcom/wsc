 ...
 * @since 160
 */
public class BulkConnectionTest extends TestCase {
    ...
    public void queryAccounts() throws AsyncApiException, IOException, InterruptedException {
        String endpoint = "http://localhost:7001/services/async/22.0/";
        ...
        BulkConnection rc = new BulkConnection(config);
        ...
        String query = "select name,id,phone,createddate from account limit 100";
    ...
    private String createBatch(String name, BulkConnection rc, JobInfo jobResult) throws AsyncApiException {
