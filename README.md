...
## Building WSC
    ...
    mvn install -DskipTests -Drelease=false

*if you wish to create a signed version of the build, use ```-Drelease=true``` and you will be prompt for entering your passphrase.
